############ This script processes E8.5 Total Cells using Seurat [v2.3.4]###############
...
M <- CreateSeuratObject(raw.data = data, min.cells =3, min.genes = 100, project= 'Total_E8.5')
######################################################################
...
############################### Define Colors ###############
my_cols_lineages <- c("#8B4513", "#FF4500", "#87CEEB", "#FFD700", "#D8BFD8", "#A9A9A9", "#FFA500", "#6B8E23")
#############################################################
...
######################### Save Robject ###############################################################
save(M, file = 'Seurat_v2.3.4_AnalysisOf_E8.5_TotalCells.Robj')
######################################################################################################