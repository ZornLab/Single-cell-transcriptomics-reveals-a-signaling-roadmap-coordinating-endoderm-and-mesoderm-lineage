############ This script processes E9.0 Mesoderm Cells using Seurat [v2.3.4]###############
...
M <- CreateSeuratObject(raw.data = data, min.cells =3, min.genes = 100, project= 'Mesoderm_E9.0')
######################################################################
...
######################### Save Robject ###############################################################
save(M, file = 'Seurat_v2.3.4_AnalysisOf_E9.0_MesodermCells.Robj')
######################################################################################################